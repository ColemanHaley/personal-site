...
I am an incoming postdoctoral scholar in the [LaGoM NLP group at KU Leuven](https://www.lagom.cs.kuleuven.be). My interests generally lie in issues pertaining to computational typology, typological diversity in NLP, low-resource languages, tokenization, and the role of linguistic structure in NLP systems, particularly with respect to morphology.
...
I completed my Ph.D. in the [CDT in Natural Language Processing](https://web.inf.ed.ac.uk/cdt/natural-language-processing) at the [University of Edinburgh](https://www.ed.ac.uk/), working with [Sharon Goldwater](https://homepages.inf.ed.ac.uk/sgwater/) and [Edoardo Ponti](https://ducdauge.github.io/) in 2026.

Before that, I graduated from [Johns Hopkins University](https://www.jhu.edu/) in 2020 with a double major in Computer Science and Cognitive Science. I was advised by [Paul Smolensky](https://cogsci.jhu.edu/directory/paul-smolensky/) and [Colin Wilson](https://colincwilson.github.io/), with whom I built more efficient Tensor Product Representation methods and interpretable neural morphological learners, respectively.
